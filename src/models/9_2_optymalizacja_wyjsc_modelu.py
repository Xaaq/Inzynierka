...
if __name__ == "__main__":
    ...
    for j in range(10):
        ...
        data_files_manager.create_parameters_file(output_parameters[0], f"tested_output_data/data_{j}.xml")

        print(f"{output_data[0][0]:.2f} {before_optimization[0][0]:.2f} {model.predict(single_data_sample)[0][0]:.2f}")
