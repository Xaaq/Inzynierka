...
if __name__ == "__main__":
    ...
    for slices in [slice(None, 200), slice(200, None), slice(None, None)]:
        input_data, output_data = data_files_manager.extract_simulation_means_data("simulation_output_data",
                                                                                   slice(None, 1),
                                                                                   slices)
        ...
        for regularization_rate in [0.3, 1]:
            learning_epochs = 300
            ...
            print(f"{slices} & {regularization_rate} & {mean_str} & {std_str} \\\\")
